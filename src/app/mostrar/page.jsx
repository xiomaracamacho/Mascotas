...
function page() {
  ...
  return (
    ...
    <div className='h-64 flex justify-center items-center'>
        <div className='bg-gray-300 rounded-full w-40 h-40 text-center'>Img</div>
        </div>
            ...
            <div className=' flex w-full'>
                ...
                <input  className='p-3 bg-[#ffffff82] placeholder:text-[#333a60] w-full rounded-r-lg' type="text"placeholder='Nombre' />
            </div>
            <div className=' flex w-full'>
                <div className='  bg-[#ffffff56]  flex items-center justify-center p-2 w-[150px]'><h1 className='font-bold text-white'>Raza:</h1></div>
                <input className='p-3 w-full bg-[#ffffff82] placeholder:text-[#333a60] rounded-r-lg' type="text"placeholder='Nombre'  />
            </div>
            <div className=' flex w-full'>
